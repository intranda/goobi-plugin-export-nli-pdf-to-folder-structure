...
**Documentation (German)**  | https://docs.goobi.io/de/workflow/plugins/export/goobi-plugin-export-nli-pdf-to-folder-structure
**Documentation (English)** | https://docs.goobi.io/en/workflow/plugins/export/goobi-plugin-export-nli-pdf-to-folder-structure
